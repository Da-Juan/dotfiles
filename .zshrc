...
# Uncomment this block and the block at the end of the file
...
plugins=(docker fzf git jq pipenv python ssh-agent virtualenv wd zsh-autosuggestions zsh-syntax-highlighting)
